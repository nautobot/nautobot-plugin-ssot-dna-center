...
def run_command(context, command, **kwargs):
    ...
    if is_truthy(context.nautobot_ssot_dna_center.local):
        ...
        if "nautobot" in results.stdout:
            ...
            compose_command = f"run --entrypoint '' nautobot '{command}'"
...
def unittest(context, keepdb=False, label="nautobot_ssot_dna_center", failfast=False, buffer=True):
